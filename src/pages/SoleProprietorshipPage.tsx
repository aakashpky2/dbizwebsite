          ...
          <div className="container-custom py-1">
            <div className="flex items-center overflow-x-auto no-scrollbar py-2 gap-1 justify-start lg:justify-center">
              {[
                ...
                { id: 'features', icon: TrendingUp, label: 'Features' },
                { id: 'benefits', icon: CheckCircle2, label: 'Benefits' },
                { id: 'comparison', icon: ArrowRightLeft, label: 'Comparison' },
                { id: 'documents', icon: FileText, label: 'Documents' },
                { id: 'process', icon: Briefcase, label: 'Process' },
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:items-start">
                ...
                <div id="deadlines" className="py-20 scroll-mt-32">
                  <div className="consultancy-section-card animate-on-scroll">
                    ...
                    <h4 className="consultancy-heading">Proprietorship Compliance Deadlines</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      {[
                        { title: "Income Tax Return (ITR-3/4)", due: "By 31st July", desc: "Annual filing of income tax for individual proprietors (or 31st Oct if audit applies)." },
                        { title: "GST Returns (GSTR-1/3B)", due: "Monthly/Quarterly", desc: "Filing of sales and tax payment returns if the business is GST registered." },
                        { title: "TDS Returns", due: "Quarterly", desc: "Filing of tax deducted at source returns if the business has TDS obligations." },
                        { title: "Shop Act Renewal", due: "State Dependent", desc: "Renewal of Shop & Establishment license as per state rules (typically 1-5 years)." }
                      ].map((item, i) => (
                ...
                <div id="penalties" className="py-20 bg-gray-50/50 scroll-mt-32 rounded-[3rem]">
                  <div className="consultancy-section-card animate-on-scroll">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {[
                        { title: "Late ITR Filing", desc: "Penalty of up to ₹5,000 for delay in filing income tax returns after the due date." },
                        { title: "GST Late Fee", desc: "Daily penalty of ₹50 (CGST+SGST) for delay in filing GSTR-3B returns." },
                        { title: "TDS Delay Interest", desc: "Interest at 1.5% per month for late payment of deducted tax." },
                        { title: "Unlimited Personal Liability", desc: "Primary risk where personal assets of the proprietor can be used to settle business debts." }
                      ].map((item, i) => (
