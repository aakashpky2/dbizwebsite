...
const soleContent = {
  description: "A Sole Proprietorship is the simplest form of business organization owned and operated by a single individual. It requires minimal regulatory formalities and is ideal for small businesses and freelancers.",
  importance: [
    "Easiest to Start: Minimal paperwork and registration requirements.",
    "Complete Control: Owner has full control over all business decisions.",
    "Low Cost: Minimal startup and operational costs.",
    "Simple Taxation: Direct taxation at individual level without separate entity tax.",
    "Flexibility: Easy to adapt and change business operations.",
    "Privacy: No requirement to disclose financial information publicly."
  ],
  faqs: [
    {
      question: "What is a Sole Proprietorship?",
      answer: "A Sole Proprietorship is a business owned and operated by a single individual. It is not a separate legal entity, and the owner is personally liable for all business debts and obligations."
    },
    {
      question: "Is registration mandatory for Sole Proprietorship?",
      answer: "No, there is no mandatory registration for Sole Proprietorship. However, you may need to obtain licenses like GST registration, Shop Act license, or professional tax registration depending on your business activities."
    },
    {
      question: "What is the liability of a Sole Proprietor?",
      answer: "The sole proprietor has unlimited liability, meaning personal assets can be used to settle business debts and obligations."
    },
    {
      question: "Can a Sole Proprietorship be converted to other business structures?",
      answer: "Yes, a Sole Proprietorship can be converted to other business structures like Partnership, LLP, or Private Limited Company as the business grows."
    }
  ]
};
      ...
      <main className="flex-grow pt-24 pb-16">
        ...
        <section id="overview" className="py-16 scroll-mt-32">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold text-dbiz-navy mb-6">What Is a Sole Proprietorship?</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">{soleContent.description}</p>
          </div>
        </section>
        ...
        <section id="benefits" className="py-16 bg-gray-50 scroll-mt-32">
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {soleContent.importance.map((item, index) => (
