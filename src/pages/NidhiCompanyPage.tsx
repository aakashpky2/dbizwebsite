...
import {
  CheckCircle2, ArrowRight, FileText, Users, Shield, Building2, FileBarChart, ArrowDownCircle, Phone, Clock, CheckCircle, MessageCircle, AlertTriangle,
  Gavel, TrendingUp
} from "lucide-react";
...
// Nidhi Company Registration Page - SEO Optimized
const EnhancedNidhiCompanyPage = () => {
      ...
      <main className="flex-grow pt-24 pb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="max-w-3xl">
                ...
                <p className="text-lg md:text-xl opacity-90 mb-10 leading-relaxed max-w-3xl animate-fade-in [animation-delay:400ms]">
                  D BIZ CONSULTANCY provides complete Nidhi Company registration services. Our expert team ensures a seamless and compliant incorporation process — from company name approval and documentation to ROC filing and post-incorporation compliance management.
                </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Minimum paid-up equity share capital requirement</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-dbiz-teal mr-2 flex-shrink-0 mt-0.5" />
                ...
                <div className="bg-gray-50 rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 mb-4 text-sm leading-relaxed">
                      As per Section 406 of the Companies Act, 2013, a Nidhi Company is a company that:
                    </p>
                    <ul className="space-y-3 text-sm">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-dbiz-teal mr-2 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Deposits and loans are allowed only between members, and must comply with specific rules relating to deposits, loans, and governance.</span>
                      </li>
                    </ul>
        ...
        <section id="features" className="py-16 bg-gray-50 scroll-mt-32 overflow-hidden">
          <div className="container-custom">
            <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-dbiz-navy mb-6">Key Features of a Nidhi Company</h2>
              ...
              {[
                {
                  ...
                  content: "A Nidhi Company has its own independent legal identity, separate from its shareholders and directors. This allows the company to own property, enter contracts, and undertake legal actions in its own name."
                },
                {
                  Icon: Shield,
                ...
                {
                  Icon: FileBarChart,
                  title: "Member-Based Operations",
                  content: "A minimum of 7 members is required at incorporation, and the company must achieve at least 200 members within one year, promoting community-based financial activities."
                },
                {
                  Icon: Users,
                  title: "Large Shareholder Base",
                  content: "A Nidhi Company must have a minimum of seven shareholders, and there is no upper limit on the number of members. This structure enables businesses to attract a wide pool of investors."
                },
                {
                  Icon: FileText,
                  title: "Operates on Mutual Benefit Principle",
                  content: "Shares of a Nidhi Company can generally be transferred without major restrictions. For listed companies, shares can be traded on recognized stock exchanges, providing liquidity to investors."
                },
                {
                  Icon: Clock,
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:border-dbiz-teal/30 hover:shadow-md transition-all">
                    <div className="flex">
                      ...
                      <div className="ml-5">
                        ...
                        <p className="text-gray-700">Promotes savings and borrowing within members, supporting mutual financial growth and stability.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:border-dbiz-teal/30 hover:shadow-md transition-all">
                    <div className="flex">
                      ...
                      <div className="ml-5">
                        ...
                        <p className="text-gray-700">Enhanced credibility and trust among members through a regulated and legally recognized business structure.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:border-dbiz-teal/30 hover:shadow-md transition-all">
                    <div className="flex">
                      ...
                      <div className="ml-5">
                        ...
                        <p className="text-gray-700">Easier access to internal funding through member deposits and structured lending within the company.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:border-dbiz-teal/30 hover:shadow-md transition-all">
                    <div className="flex">
                      ...
                      <div className="ml-5">
                        ...
                        <p className="text-gray-700">Ownership and management structure that supports community-based participation and regulated operations.</p>
                      </div>
                    </div>
                  </div>
        ...
        <section id="process" className="py-24 bg-dbiz-navy text-white scroll-mt-32 relative overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Nidhi Company Registration Process</h2>

              <div className="text-lg text-white/80 mb-8 leading-relaxed max-w-5xl mx-auto flex flex-col items-center">
                <p className="text-center">Registering a Nidhi Company{location ? ` in ${cityName}` : ""} involves several legal and procedural steps under the Companies Act, 2013 and regulations issued by the Ministry of Corporate Affairs (MCA).</p>
              </div>
            </div>
        ...
        <div id="deadlines" className="py-20 scroll-mt-32">
          <div className="consultancy-section-card animate-on-scroll">
            ...
            <h4 className="consultancy-heading">Mandatory MCA Compliance for Nidhi Companies</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
          ...
          <div className="consultancy-section-card animate-on-scroll">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { title: "Non-Compliance Risks", desc: "Loss of Nidhi status and restrictions on accepting deposits or making loans." },
        ...
        <div className="mt-16 text-center animate-on-scroll">
          ...
          <p className="max-w-4xl mx-auto text-[19.125px] text-gray-700 leading-relaxed font-medium">
            With our expertise and structured approach, D BIZ CONSULTANCY becomes your trusted partner in building and managing a compliant and successful Nidhi Company. While we handle the compliance and process, you can focus on growing your member network and operations.
          </p>
        </div>
        <section id="faqs" className="py-20 bg-gray-50 scroll-mt-32">
          <div className="container-custom">
            <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-dbiz-navy mb-6">FAQs on Nidhi Company Registration</h2>
...
export default EnhancedNidhiCompanyPage;
