...
import { CheckCircle2, ArrowDownCircle, Phone, MessageCircle, Building2, Users, FileText, Target, TrendingUp } from "lucide-react";
...
const content = {
  description: "A comprehensive business plan is your roadmap to success. Our expert team creates detailed, investor-ready business plans that clearly articulate your vision, strategy, and financial projections.",
  benefits: [
    "Investor Ready: Professional format that meets investor expectations",
    "Strategic Clarity: Clear articulation of business model and strategy",
    "Financial Projections: Detailed 5-year financial forecasts",
    "Market Analysis: In-depth research on target market and competition",
    "Risk Mitigation: Identification of risks and mitigation strategies",
    "Bank Loan Approval: Increases chances of loan approval"
  ],
  features: [
    { title: "Executive Summary", description: "Compelling overview of your business opportunity and key highlights" },
    { title: "Market Analysis", description: "Detailed research on industry trends, target market, and competition" },
    { title: "Business Model", description: "Clear explanation of revenue streams and value proposition" },
    { title: "Financial Projections", description: "5-year P&L, cash flow, and balance sheet projections" },
    { title: "Marketing Strategy", description: "Go-to-market strategy and customer acquisition plan" },
    { title: "Operations Plan", description: "Operational structure, team, and milestone roadmap" }
  ],
  faqs: [
    { question: "Why do I need a business plan?", answer: "A business plan serves as a roadmap for your business, helps secure funding from investors and banks, provides clarity on goals and strategies, and helps identify potential challenges before they arise." },
    { question: "How long does it take to create a business plan?", answer: "Typically, a comprehensive business plan takes 2-3 weeks to complete. This includes research, analysis, financial modeling, and multiple rounds of review and refinement." },
    { question: "What information do you need from me?", answer: "We need details about your business idea, target market, competition, team background, funding requirements, and any existing financial data. Our team will guide you through a structured questionnaire." },
    { question: "Can you customize the plan for specific investors?", answer: "Yes, we tailor business plans based on your target audience - whether it's angel investors, VCs, banks, or government schemes. Each has different expectations and focus areas." }
  ]
};
      ...
      <main className="flex-grow pt-24 pb-16">
        <section className="relative bg-gradient-to-r from-dbiz-navy to-dbiz-navy/90 text-white py-20 overflow-hidden">
          <div className="absolute inset-0 z-0 opacity-10">
            <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40" alt="Background" className="w-full h-full object-cover" />
          </div>
          <div className="container-custom relative z-10">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="max-w-3xl">
                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 leading-tight">
                  Business Plan Services{location && <span className="block text-2xl md:text-3xl mt-2">in {cityName}</span>}
                </h1>
              ...
              <div className="hidden md:block">
                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f" alt="Business Plan" className="w-full h-80 rounded-lg shadow-lg object-cover" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container-custom py-2">
            <div className="flex items-center overflow-x-auto no-scrollbar">
              ...
              <div className={`px-4 py-3 whitespace-nowrap cursor-pointer flex items-center border-b-2 font-medium ${isActive('features') ? 'text-dbiz-teal border-dbiz-teal' : 'text-gray-600 border-transparent hover:text-dbiz-navy'}`} onClick={() => handleSectionClick('features')}>
                <FileText className="mr-2 h-4 w-4" /> What's Included
              </div>
        ...
        <section id="overview" className="py-16 scroll-mt-32">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold text-dbiz-navy mb-6">Professional Business Plan Services</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {content.features.map((feature, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  <Target className="text-dbiz-teal h-8 w-8 mb-4" />
        ...
        <section id="benefits" className="py-16 scroll-mt-32">
          <div className="container-custom">
            <h2 className="text-3xl font-bold text-dbiz-navy mb-8 text-center">Benefits of Our Business Plans</h2>
