      ...
      <section id="documents" className="py-24 bg-gray-50 scroll-mt-32">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-lg border border-gray-100 overflow-hidden group hover:shadow-2xl transition-all duration-500">
              <div className="bg-dbiz-navy p-8 text-white flex items-center gap-4">
                ...
                <h3 className="text-2xl font-bold tracking-tight uppercase">Statutory Documents</h3>
              </div>
          ...
          <div className="mt-16 max-w-5xl mx-auto">
            <div className="bg-[#f0f4f8] rounded-[3rem] p-10 md:p-14 border border-gray-200">
              <h3 className="text-2xl font-black text-dbiz-navy mb-8 text-center uppercase tracking-tight">Additional Compliance Documents (Public Limited Specific)</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  "Details of Minimum 3 Directors",
                  "Minimum 7 Shareholders Information",
                  ...
                  <div key={i} className="flex items-center gap-3 bg-white p-4 rounded-2xl shadow-sm border border-gray-100 group hover:-translate-y-1 transition-transform">
                    <ArrowRight className="h-4 w-4 text-dbiz-teal" />
                    <span className="text-sm font-bold text-dbiz-navy leading-tight">{item}</span>
                  </div>
                ))}
              </div>
            </div>
