...
const content = {
  description: "MCA Compliance refers to meeting the statutory requirements mandated by the Ministry of Corporate Affairs for companies registered in India. It includes filing annual returns, financial statements, maintaining statutory registers, and conducting board meetings as per the Companies Act, 2013.",
  importance: [
    "Legal Requirement: Mandatory for all registered companies under Companies Act.",
    "Avoid Penalties: Prevents heavy fines and legal consequences for non-compliance.",
    "Good Standing: Maintains company's active status with the ROC.",
    "Director Protection: Prevents disqualification of directors due to defaults.",
    "Business Continuity: Essential for smooth business operations and reputation.",
    "Stakeholder Confidence: Demonstrates professionalism and regulatory adherence."
  ],
  faqs: [
    {
      question: "What is MCA Compliance?",
      answer: "MCA Compliance involves fulfilling all statutory requirements under the Companies Act, 2013, including filing annual returns (MGT-7), financial statements (AOC-4), conducting board meetings, maintaining statutory registers, and other mandatory filings with the Registrar of Companies."
    },
    {
      question: "What are the key MCA compliance requirements?",
      answer: "Key requirements include: Annual return filing, Financial statements filing, Board meetings (minimum 4 per year), Audit of accounts, Maintaining statutory registers, Director KYC, and various event-based filings like change in directors, registered office, or capital."
    },
    {
      question: "What is the penalty for MCA non-compliance?",
      answer: "Penalties vary based on the nature of default. Late filing attracts penalties ranging from ₹100 per day to ₹100 per day for company + ₹100 per day for directors. Prolonged defaults can lead to director disqualification and company strike-off."
    },
    {
      question: "When should companies file MCA returns?",
      answer: "Annual Return (MGT-7) must be filed within 60 days of AGM. Financial Statements (AOC-4) within 30 days of AGM. Companies must hold AGM within 6 months from financial year-end."
    }
  ]
};
      ...
      <main className="flex-grow pt-24 pb-16">
        ...
        <section id="overview" className="py-16 scroll-mt-32">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold text-dbiz-navy mb-6">What Is MCA Compliance?</h2>
