...
import { CheckCircle2, ChevronRight, ArrowRight, FileText, Users, Shield, Building2, FileBarChart, ArrowDownCircle, Phone, Clock, CheckCircle, MessageCircle, AlertTriangle, AlertCircle, Info,
  Gavel
} from "lucide-react";
              ...
              <ul className="space-y-5">
                ...
                <div id="deadlines" className="py-20 scroll-mt-32">
                  <div className="consultancy-section-card animate-on-scroll">
                    ...
                    <h4 className="consultancy-heading">Partnership Compliance Deadlines</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      {[
                        { title: "Income Tax Return (ITR-5)", due: "By 31st July", desc: "Annual filing of income tax for the partnership firm (or 31st Oct if audit applies)." },
                        { title: "GST Returns (GSTR-1/3B)", due: "Monthly/Quarterly", desc: "Filing of sales and tax payment returns if the firm is GST registered." },
                        { title: "Statutory Audit", due: "Threshold Based", desc: "Mandatory if turnover exceeds ₹1 Crore (Business) or ₹50 Lakhs (Profession)." },
                        { title: "TDS Returns", due: "Quarterly", desc: "Filing of tax deducted at source returns for salaries or vendor payments." }
                      ].map((item, i) => (
                ...
                <div id="penalties" className="py-20 bg-gray-50/50 scroll-mt-32 rounded-[3rem]">
                  <div className="consultancy-section-card animate-on-scroll">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {[
                        { title: "Late ITR Filing", desc: "Penalty of up to ₹5,000 for delay in filing firm's income tax returns after due date." },
                        { title: "GST Late Fee", desc: "Daily penalty of ₹50 (CGST+SGST) for delay in filing GSTR-3B returns." },
                        { title: "Joint & Several Liability", desc: "Partners are personally and collectively responsible for all business debts." },
                        { title: "Non-Registration Risks", desc: "Unregistered firms cannot sue third parties or other partners for contract enforcement." }
                      ].map((item, i) => (
